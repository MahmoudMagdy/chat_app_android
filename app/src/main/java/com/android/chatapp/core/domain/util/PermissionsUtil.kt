...
fun Context.checkMultiplePermissions(permissions: List<Permission>): List<PermissionResult> =
...
fun Context.permissionsState(permissions: List<Permission>): PermissionsState =
